...
public class SMSC
{
	...
	const string SMSC_LOGIN = "kaynov.02";		    // логин клиента
	const string SMSC_PASSWORD = "a0c3d9330e339bdf10d7649da8d2e5c5627dc38d";	// пароль или MD5-хеш пароля в нижнем регистре
